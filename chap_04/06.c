...
// and adding the second yields 82. Subtract- ing 1 gives 81. The remainder upon
// dividing by 10 is 1. When the remainder is subtracted from 9, the result is
// 8, which matches the last digit of the original code. Your job is to mod- ify
...
int main(void)
{
	...
	scanf("%1d%1d%1d%1d%1d%1d%1d%1d%1d%1d%1d%1d", &d1,
	       &d2, &d3, &d4, &d5, &d6, &d7,
	       &d8, &d9, &d10, &d11, &d12);
